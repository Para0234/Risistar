...
<head>
	...
	-->
	<meta name="keywords" content="Weltraum Browsergame, XNova, 2Moons, Space, Private, Server, Speed, Risistar">
	<meta name="description" content="A spatial game powered by RSA and pure laziness"> <!-- Noob Check :) -->
	<!-- New code -->
