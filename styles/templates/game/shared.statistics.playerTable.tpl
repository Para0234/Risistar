<tr>
	...
	<th>{$LNG.st_points}</th><th style="display:none">{$LNG.st_buildings}</th>
		<th style="display:none">{$LNG.st_researh}</th>
		<th style="display:none">{$LNG.st_fleets}</th>
		<th style="display:none">{$LNG.st_defenses}</th>
...
<tr>
	...
	<td style="display:none">{$RangeInfo.build}</td><td style="display:none">{$RangeInfo.tech}</td><td style="display:none">{$RangeInfo.fleet}</td><td style="display:none">{$RangeInfo.defs}</td>
	<td>{$RangeInfo.total}</td>
</tr>
{/foreach}

<td style="display:none">remettre en place si on veut le détails des points</td>
