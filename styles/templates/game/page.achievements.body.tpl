...
<table>
<tr>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_mines}<p>{$LNG.achievements_t}<font color=yellow>{$mines_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$mines_req}</font> {$LNG.achievements_t2_1}</b>">{$mines_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_tech}<p>{$LNG.achievements_t}<font color=yellow>{$tech_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$tech_req}</font> {$LNG.achievements_t2_1}</b>">{$tech_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_engine}<p>{$LNG.achievements_t}<font color=yellow>{$engine_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$engine_req}</font> {$LNG.achievements_t2_1}</b>">{$engine_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_colonization}<p>{$LNG.achievements_t}<font color=yellow>{$colonization_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$colonization_req}</font> {$LNG.achievements_t2_1}</b>">{$colonization_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_moon}<p>{$LNG.achievements_t}<font color=yellow>{$moon_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$moon_req}</font> {$LNG.achievements_t2_1}</b>">{$moon_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_war}<p>{$LNG.achievements_t}<font color=yellow>{$war_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$war_req}</font> {$LNG.achievements_t2_1}</b>">{$war_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_destroy}<p>{$LNG.achievements_t}<font color=yellow>{$destroy_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$destroy_req}</font> {$LNG.achievements_t2_1}</b>">{$destroy_badge}</a></td>
</tr>
<tr>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_time}<p>{$LNG.achievements_t}<font color=yellow>{$time_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$time_req}</font> {$LNG.achievements_t2_1}</b>">{$time_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_storage}<p>{$LNG.achievements_t}<font color=yellow>{$store_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$store_req}</font> {$LNG.achievements_t2_1}</b>">{$storage_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_community}<p>{$LNG.achievements_t}<font color=yellow>{$community_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$community_req}</font> {$LNG.achievements_t2_1}</b>">{$community_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_fleet}<p>{$LNG.achievements_t}<font color=yellow>{$fleet_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$fleet_req}</font> {$LNG.achievements_t2_1}</b>">{$fleet_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_darkmatter}<p>{$LNG.achievements_t}<font color=yellow>{$darkmatter_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$darkmatter_req}</font> {$LNG.achievements_t2_1}</b>">{$darkmatter_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_planet}<p>{$LNG.achievements_t}<font color=yellow>{$planet_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$planet_req}</font> {$LNG.achievements_t2_1}</b>">{$planet_badge}</a></td>
<td colspan=4><a class="tooltip" href="#"  data-tooltip-content="<b>{$LNG.achievements_lab}<p>{$LNG.achievements_t}<font color=yellow>{$lab_amount}</font> {$LNG.achievements_t2}<br>{$LNG.achievements_t3}<font color=yellow>{$lab_req}</font> {$LNG.achievements_t2_1}</b>">{$lab_badge}</a></td>
</tr>
</table>
...
<p align=right><b>{$LNG.achievements_t4}{$mines_amount} {$LNG.achievements_b2}&nbsp </b>
...
<p align=right><b>{$LNG.achievements_t4}{$tech_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$engine_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$colonization_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$moon_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$war_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$destroy_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$time_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<tr>	
<td>
<a class="link" onclick="$('#store').slideToggle();return false" href="#"><p align=left>
&nbsp <b>{$store_title}</b></a>
<p align=right><b>{$LNG.achievements_t4}{$store_amount} {$LNG.achievements_b2}&nbsp </b></a>
<div id="store" style="display: none;">
<table style="width:100%">

<b>{$LNG.achievements_storage_text1} <font color=yellow>{$store_req1}</font> {$LNG.achievements_storage_text2} <font color=yellow>{$store_req2}</font> {$LNG.achievements_storage_text3} <font color=yellow>{$store_req3}</font></b><br><br>
<b>{$LNG.achievements_storage_text4} <font color=yellow>{$store_max_req1}</font> {$LNG.achievements_storage_text5} <font color=yellow>{$store_max_req2}</font> {$LNG.achievements_storage_text6} <font color=yellow>{$store_max_req3}</font></b><br><br>


<tr>
<td width="80">
{$store1_img}</td>
<td><b><p align=left>{$store1_title}</p>{$LNG.achievements_storage1_desc}</b><p>
<b>{$store1_req1} {$store1_req2} {$store1_req3}</b></td>
</tr>

<tr>
<td width="80">
{$store2_img}</td>
<td><b><p align=left>{$store2_title}</p>{$LNG.achievements_storage2_desc}</b><p>
<b>{$store2_req1} {$store2_req2} {$store2_req3}</b></td>
</tr>

<tr>
<td width="80">
{$store3_img}</td>
<td><b><p align=left>{$store3_title}</p>{$LNG.achievements_storage3_desc}</b><p>
<b>{$store3_req1} {$store3_req2} {$store3_req3}</b></td>
</tr>

<tr>
<td width="80">
{$store4_img}</td>
<td><b><p align=left>{$store4_title}</p>{$LNG.achievements_storage4_desc}</b><p>
<b>{$store4_req1} {$store4_req2} {$store4_req3}</b></td>
</tr>
...
<p align=right><b>{$LNG.achievements_t4}{$community_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$fleet_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$darkmatter_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$planet_amount} {$LNG.achievements_b2}&nbsp </b></a>
...
<p align=right><b>{$LNG.achievements_t4}{$lab_amount} {$LNG.achievements_b2}&nbsp </b></a>
