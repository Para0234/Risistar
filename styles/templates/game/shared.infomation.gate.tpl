	...
	<tbody>
		...
		{else}
			...
			{if !empty($gateData.gateList)}
				...
				{/foreach}
				<!-- Ajout des boutons Tous / Aucun vaisseaux-->
				<tr>
    			<td colspan="3" style="text-align:center;">
        		<a href="javascript:Gate.noShips();">{$LNG.fl_remove_all_ships}</a>
				&nbsp;|&nbsp;
				<a href="javascript:Gate.maxShips();">{$LNG.fl_select_all_ships}</a>
    			</td>
				</tr>
				<tr>
			...
			{else}
				<tr style="height:20px;">
					<td colspan="4"><span style="color:red">{$LNG.in_jump_gate_no_target}</span></td>
				</tr>
			{/if}
		{/if}
	</tbody>
